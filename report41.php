         ...
         <div class="col-12 d-flex mt-5 justify-content-center" >   
            <div class="card" style="width:40rem; height:20rem;">
                <div class="card-header">
                    <h5 class="card-title">Category Ranks</h5>
                    <h6 class="card-subtitle mb-2 text-muted">Category wise ranks in different colleges</h6>
                </div>
                <div class="card-body">
                <form action = "validation4.php" method = "post" style="min-height:400px;">
